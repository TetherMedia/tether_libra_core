...
class ValidatorPublicKeys extends $pb.GeneratedMessage {
  ...
  ValidatorPublicKeys() : super();
  ValidatorPublicKeys.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ValidatorPublicKeys.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ValidatorPublicKeys create() => ValidatorPublicKeys();

...
class LedgerInfo extends $pb.GeneratedMessage {
  ...
  LedgerInfo() : super();
  LedgerInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LedgerInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static LedgerInfo create() => LedgerInfo();
...
class LedgerInfoWithSignatures extends $pb.GeneratedMessage {
  ...
  LedgerInfoWithSignatures() : super();
  LedgerInfoWithSignatures.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LedgerInfoWithSignatures.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static LedgerInfoWithSignatures create() => LedgerInfoWithSignatures();
...
class ValidatorSignature extends $pb.GeneratedMessage {
  ...
  ValidatorSignature() : super();
  ValidatorSignature.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ValidatorSignature.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static ValidatorSignature create() => ValidatorSignature();

...
import 'vm_errors.pb.dart' as $11;
...
class SubmitTransactionRequest extends $pb.GeneratedMessage {
  ...
  SubmitTransactionRequest() : super();
  SubmitTransactionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SubmitTransactionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static SubmitTransactionRequest create() => SubmitTransactionRequest();
...
class AdmissionControlStatus extends $pb.GeneratedMessage {
  ...
  AdmissionControlStatus() : super();
  AdmissionControlStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdmissionControlStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static AdmissionControlStatus create() => AdmissionControlStatus();
...
class SubmitTransactionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SubmitTransactionResponse', package: const $pb.PackageName('admission_control'))
    ..a<$11.VMStatus>(1, 'vmStatus', $pb.PbFieldType.OM, $11.VMStatus.getDefault, $11.VMStatus.create)
    ..a<AdmissionControlStatus>(2, 'acStatus', $pb.PbFieldType.OM, AdmissionControlStatus.getDefault, AdmissionControlStatus.create)
    ..a<$12.MempoolAddTransactionStatus>(3, 'mempoolStatus', $pb.PbFieldType.OM, $12.MempoolAddTransactionStatus.getDefault, $12.MempoolAddTransactionStatus.create)
    ..a<$core.List<$core.int>>(4, 'validatorId', $pb.PbFieldType.OY)
    ..oo(0, [1, 2, 3])
    ..hasRequiredFields = false
  ;

  SubmitTransactionResponse() : super();
  SubmitTransactionResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SubmitTransactionResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static SubmitTransactionResponse create() => SubmitTransactionResponse();
  ...
  $11.VMStatus get vmStatus => $_getN(0);
  set vmStatus($11.VMStatus v) { setField(1, v); }
  ...
  $12.MempoolAddTransactionStatus get mempoolStatus => $_getN(2);
  set mempoolStatus($12.MempoolAddTransactionStatus v) { setField(3, v); }
